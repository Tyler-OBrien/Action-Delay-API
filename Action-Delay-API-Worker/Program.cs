...
namespace Action_Deplay_API_Worker
{
  ...
  "[{Timestamp:yyyy-MM-dd HH:mm:ss.fff zzz}] [{Level:u3}] [{SourceContext}:{Resolver}:{RunType}] {Message:lj} {Exception}{NewLine}";
        ...
        public static async Task<int> Main(string[] args)
        {
            ...
            var lookupClientOptionsAny = new LookupClientOptions(CloudflareV6, GoogleV6);
            ...
            var lookupClientOptionsV4 = new LookupClientOptions(CloudflareV4, GoogleV4);
            lookupClientOptionsAny.UseCache = true;
            lookupClientOptionsAny.UseRandomNameServer = false;
        ...
        public static readonly IPAddress GoogleV4 = IPAddress.Parse("1.1.1.1");
        public static readonly IPAddress GoogleV6 = IPAddress.Parse("1.1.1.1");
